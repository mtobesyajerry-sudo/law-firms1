...
export function generateEffectivenessNarrative(rating, responses) {
  ...
  if (rating === 'Effective') {
    ...
    narrative += `The Mixed effectiveness rating indicates that while foundational controls are established, significant operational weaknesses prevent the institution from achieving consistent, high-quality risk mitigation outcomes. The institution must prioritize enhancement of operational effectiveness through targeted remediation efforts, resource allocation, training initiatives, process improvements, and strengthened management oversight and accountability. Specific attention should be directed to areas demonstrating weak or ineffective performance, including enhancement of transaction monitoring quality, improvement of suspicious transaction report quality and timeliness, strengthening of sanctions screening effectiveness, and improvement of management information and oversight mechanisms.`;
  } else if (rating === 'Weak') {
