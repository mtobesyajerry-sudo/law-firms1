...
export function getSectorLabels(sector) {
  ...
  if (sector === 'accounting' || sector === 'audit_firm') {
    return {
      subtitle:           'Client management, KYC operations, and engagement handling',
      myMatters:          'My Engagements',
      myClients:          'My Clients',
      myActiveMatters:    'My Active Engagements',
      myAssignedClients:  'My Assigned Clients',
      noMatters:          'No engagements assigned',
      noClients:          'No clients assigned',
      manageMatters:      'Manage Engagements',
      manageClients:      'Manage Clients',
      firmDashboard:      'Firm Dashboard',
      matterMgmtTitle:    'Engagement Management',
      matterMgmtSubtitle: 'Client engagement tracking and compliance monitoring',
      addMatter:          '+ Add New Engagement',
      totalMatters:       'Total Engagements',
      openMatters:        'Open Engagements',
      highRiskMatters:    'High Risk Engagements',
      tabAllMatters:      'All Engagements',
      noMattersFound:     'No engagements found. Add your first engagement to get started.',
