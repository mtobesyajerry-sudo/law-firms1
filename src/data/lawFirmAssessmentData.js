...
// MODULE 4: MATURITY RISK - "How mature and resilient is the AML/CFT framework?"

const module4Questions = {
  'D1': {
    title: 'D1. GOVERNANCE MATURITY',
    description: 'Assessment of AML/CFT governance integration and strategic oversight',
    questions: [
      {
        code: 'D1.1',
        text: 'Is AML/CFT embedded in the firm\'s strategic and business planning?',
        type: 'maturity',
        ...
        guidance: {
          ...
          'Developing': 'AML discussed in business planning but not systematically integrated',
          'Advanced': 'AML fully embedded in strategic decisions, expansion plans, and practice area development'
        }
      },
      {
        code: 'D1.2',
        text: 'Are partners actively engaged in AML/CFT decision-making?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 1,
        weight: 1,
        guidance: {
          'Basic': 'Partners have limited involvement or delegate entirely to compliance officer',
          'Developing': 'Partners review high-risk matters but not systematically engaged',
          'Advanced': 'Partners regularly review AML performance, approve high-risk clients, and champion compliance'
        }
      },
      {
        code: 'D1.3',
        text: 'Is AML/CFT included in performance and accountability frameworks?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 1,
        weight: 1,
        guidance: {
          'Basic': 'No linkage between AML compliance and staff performance',
          'Developing': 'AML mentioned in reviews but not formally measured',
          'Advanced': 'AML compliance formally assessed in performance reviews with clear accountability'
        }
      },
      {
        code: 'D1.4',
        text: 'Are high-risk engagements reviewed periodically by partners?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'No periodic review process',
          'Developing': 'Ad-hoc reviews when issues arise',
          'Advanced': 'Scheduled periodic reviews of all high-risk clients and matters'
        }
      },
      {
        code: 'D1.5',
        text: 'Are AML/CFT risks considered in expansion or new practice areas?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 3,
        weight: 1,
        guidance: {
          'Basic': 'AML not considered in expansion decisions',
          'Developing': 'AML considered informally',
          'Advanced': 'Formal AML risk assessment required before entering new practice areas or markets'
        }
      }
    ]
  },
  'D2': {
    title: 'D2. RISK CULTURE AND ACCOUNTABILITY',
    description: 'Assessment of organizational risk culture and staff accountability',
    questions: [
      {
        code: 'D2.1',
        text: 'Do staff demonstrate awareness of AML/CFT risks in daily work?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 1,
        weight: 1,
        guidance: {
          'Basic': 'Staff show limited awareness or view AML as compliance burden',
          'Developing': 'Staff aware but inconsistent application',
          'Advanced': 'Strong risk awareness culture with proactive identification and escalation'
        }
      },
      {
        code: 'D2.2',
        text: 'Are AML responsibilities clearly linked to performance reviews?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'No linkage between AML and performance management',
          'Developing': 'AML mentioned but not measured',
          'Advanced': 'AML compliance formally assessed with consequences for breaches'
        }
      },
      {
        code: 'D2.3',
        text: 'Is escalation encouraged without fear of retaliation?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 1,
        weight: 1,
        guidance: {
          'Basic': 'No clear speak-up culture or fear of reporting',
          'Developing': 'Escalation allowed but not actively encouraged',
          'Advanced': 'Strong speak-up culture with protection for whistleblowers'
        }
      },
      {
        code: 'D2.4',
        text: 'Are failures analysed to improve controls?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'Failures not systematically reviewed',
          'Developing': 'Root cause analysis conducted but lessons not consistently applied',
          'Advanced': 'Systematic root cause analysis with documented control improvements'
        }
      }
    ]
  },
  'D3': {
    title: 'D3. DATA, TECHNOLOGY AND DOCUMENTATION',
    description: 'Assessment of technology, documentation, and data management maturity',
    questions: [
      {
        code: 'D3.1',
        text: 'Are AML decisions supported by documented audit trails?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 1,
        weight: 1,
        guidance: {
          'Basic': 'Limited documentation of AML decisions',
          'Developing': 'Key decisions documented but inconsistently',
          'Advanced': 'Comprehensive audit trails for all AML decisions with rationale'
        }
      },
      {
        code: 'D3.2',
        text: 'Does the firm use technology or structured tools for AML monitoring?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'Manual processes only, no technology tools',
          'Developing': 'Basic spreadsheets or simple databases',
          'Advanced': 'Dedicated AML software, case management systems, or automated monitoring'
        }
      },
      {
        code: 'D3.3',
        text: 'Is there centralised documentation of high-risk clients?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'Decentralized files, no central register',
          'Developing': 'Central list maintained but limited detail',
          'Advanced': 'Comprehensive central register with risk ratings, reviews, and alerts'
        }
      },
      {
        code: 'D3.4',
        text: 'Are data protection and confidentiality integrated with AML?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 3,
        weight: 1,
        guidance: {
          'Basic': 'Data protection and AML treated separately',
          'Developing': 'Some coordination between functions',
          'Advanced': 'Fully integrated framework balancing AML obligations with data protection'
        }
      }
    ]
  },
  'D4': {
    title: 'D4. CONTINUOUS IMPROVEMENT AND LEARNING',
    description: 'Assessment of continuous improvement, learning, and adaptation processes',
    questions: [
      {
        code: 'D4.1',
        text: 'Does the firm incorporate regulatory feedback into controls?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 1,
        weight: 1,
        guidance: {
          'Basic': 'Limited response to regulatory guidance',
          'Developing': 'Reactive response to regulatory findings',
          'Advanced': 'Proactive monitoring of regulatory expectations with systematic updates'
        }
      },
      {
        code: 'D4.2',
        text: 'Are emerging typologies regularly communicated to staff?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'No systematic communication of typologies',
          'Developing': 'Occasional updates when major typologies emerge',
          'Advanced': 'Regular typology briefings, alerts, and training updates'
        }
      },
      {
        code: 'D4.3',
        text: 'Are lessons from suspicious cases integrated into policies?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 2,
        weight: 1,
        guidance: {
          'Basic': 'Suspicious cases not used for learning',
          'Developing': 'Ad-hoc policy updates',
          'Advanced': 'Systematic review of STR cases with policy and training enhancements'
        }
      },
      {
        code: 'D4.4',
        text: 'Is periodic benchmarking conducted against peer firms?',
        type: 'maturity',
        options: ['Basic', 'Developing', 'Advanced'],
        minTier: 3,
        weight: 1,
        guidance: {
          'Basic': 'No external benchmarking',
          'Developing': 'Informal comparison with peers',
          'Advanced': 'Formal benchmarking exercises with documented gap analysis and improvement plans'
        }
      }
    ]
  }
...
export const lawFirmsModules = {
  ...
  module4: {
    code: 'module4',
    title: 'CATEGORY (D): MATURITY RISK (ADVANCED GOVERNANCE)',
    description: 'How mature and resilient is the AML/CFT framework?',
    sections: module4Questions
  }
};
