/*
  # Create EDD Document Templates Tracking System
...
-- Seed initial EDD document types (8 comprehensive templates)
...
('PEP Assessment Form', 'Comprehensive risk assessment and approval form for PEP relationships', 'High', 2),
('Enhanced DD Questionnaire', 'Detailed questionnaire for source of wealth and funds verification', 'High', 3),
('Public Records Search Results', 'Documentation of searches conducted in public databases and media', 'High', 4),
('Senior Management Approval', 'Written approval from senior management for client onboarding', 'High', 5),
('Ongoing Monitoring Checklist', 'Checklist and schedule for enhanced ongoing monitoring', 'High', 6),
