...
INSERT INTO document_types (code, name, category, description, client_type, validity_months) VALUES
  ...
  ('utility_bill', 'Utility Bill', 'address', 'Recent utility bill', 'both', 6),
  ('tenancy_agreement', 'Tenancy Agreement', 'address', 'Rental agreement', 'both', 24),
  ...
  ('source_of_funds', 'Source of Funds Verification', 'financial', 'SOF evidence', 'both', 12),
  ...
  ('tin_certificate', 'TIN Certificate', 'regulatory', 'Tax ID certificate', 'legal_entity', 0),
  ...
  ('bank_reference', 'Bank Reference', 'financial', 'Bank reference letter', 'legal_entity', 12),
...
INSERT INTO dd_level_document_requirements (dd_level, client_type, document_type_id, is_mandatory, priority, description) VALUES
  ...
  ('standard', 'individual', (SELECT id FROM document_types WHERE code = 'employment_letter'), true, 4, 'Employment verification'),
  ('standard', 'individual', (SELECT id FROM document_types WHERE code = 'payslip'), false, 5, 'Income verification'),
  ('standard', 'individual', (SELECT id FROM document_types WHERE code = 'source_of_funds'), true, 6, 'Source of funds'),
  ('standard', 'individual', (SELECT id FROM document_types WHERE code = 'client_declaration'), true, 7, 'Client declaration')
...
INSERT INTO dd_level_document_requirements (dd_level, client_type, document_type_id, is_mandatory, priority, description) VALUES
  ...
  ('enhanced', 'individual', (SELECT id FROM document_types WHERE code = 'source_of_funds'), true, 8, 'SOF'),
...
INSERT INTO dd_level_document_requirements (dd_level, client_type, document_type_id, is_mandatory, priority, description) VALUES
  ...
  ('simplified', 'legal_entity', (SELECT id FROM document_types WHERE code = 'tin_certificate'), true, 3, 'TIN'),
