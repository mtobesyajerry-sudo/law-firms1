...
/*
  # Fix encrypt_kyc_client_pii trigger — remove legacy client_name sync

  The client_name plaintext column was dropped in Step 6. The trigger still
  contained a line setting NEW.client_name = v_client_name which now throws
  "record NEW has no field client_name". This migration removes that line.
*/
